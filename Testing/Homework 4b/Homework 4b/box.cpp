...
std::ostream &FilledBox::operator<<(std::ostream & os) {
	this->print(os);
	return os;
}
std::ostream &FilledBox::operator<<(std::ostream & os) const {
	this->print(os);
	return os;
}
...
std::ostream &HollowBox::operator<<(std::ostream & os) {
	this->print(os);
	return os;
}
std::ostream &HollowBox::operator<<(std::ostream & os) const {
	this->print(os);
	return os;
}
...
std::ostream &CheckeredBox::operator<<(std::ostream & os) {
	this->print(os);
	return os;
}
std::ostream &CheckeredBox::operator<<(std::ostream & os) const{
	this->print(os);
	return os;
}
